...
- <p className="inline-flex gap-1">👨‍💻 全网同名阿黄(Kuizuo)，头像[酷乐](https://baike.baidu.com/item/%E9%85%B7%E4%B9%90/18058703) <img src="/img/logo.webp" width="26" heigth="26" className="rounded-full" /></p>
...
- Xiaomi MIX Fold 2 (折叠屏其实不那么好用，准备换 iphone 16 了)
...
<p style={{ display: 'flex', 'align-items': 'center', gap: '0.5rem' }}>
  ...
  <a href={social.github.href} target="_blank">loner</a>
</p>

<p style={{ display: 'flex', 'align-items': 'center', gap: '0.5rem' }}>
  <Icon icon="ri:mail-open-line" width="20" heigth="20" />
  <a href={social.email.href} target="_blank">hbh3737@163.com</a>
</p>
